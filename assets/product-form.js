  ...
  customElements.define(
    ...
    class ProductForm extends HTMLElement {
      constructor() {
        ...
        const selectedDropdown = document.querySelectorAll(
          ".dropdown-selected-la"
        );
        this.itemSize = document.querySelectorAll(".available-value-la");
        this.productId = document
          .querySelector(".product-la")
        ...
        this.itemSize.forEach((el) => {
          el.addEventListener("click", (e) => {
            ...
            selectedDropdown.forEach((el) => {
              ...
              this.headerDropdown.parentElement.classList.remove(
                "active-select-la"
              );
            });
          });
        ...
        if (window.innerWidth <= 989) {
          ...
          const announcementBarPositionLa = document.querySelector(
            ".announcement_bar-la"
          );
          ...
          this.itemSize &&
            this.itemSize.forEach((el) => {
              el.addEventListener("click", () => {
                ...
                headerPositionLa?.classList.remove(
                  "header-collapsible-overflow-la"
                );
                announcementBarPositionLa?.classList.remove(
          ...
          if (sizePopup && sizeButton && bihendSelected) {
            sizeButton.addEventListener("click", () => {
              ...
              announcementBarPositionLa?.classList.add(
                "announcement-collapsible-overflow-la"
              );
            ...
            bihendSelected &&
              bihendSelected.addEventListener("click", () => {
                sizePopup.classList.remove("size-popup-active");
                document.body.classList.remove("no-scroll-body");
                bihendSelected.classList.remove("bihend-selecet-active-la");
                headerPositionLa?.classList.remove(
        ...
        this.headerDropdown &&
          this.headerDropdown.addEventListener("click", () => {
            this.headerDropdown.parentElement.classList.toggle(
              "active-select-la"
            );
          });
      ...
      updateCartDrawer() {
        fetch("/?section_id=new-cart-drawer")
          ...
          .then((html) => {
            ...
            const newCartDrawer = newDocument.querySelector(".cart-drawer-la");
            const oldCartDrawer = document.querySelector(".cart-drawer-la");

            if (oldCartDrawer && newCartDrawer) {
              oldCartDrawer.replaceWith(newCartDrawer);
              this.cartDrawer = newCartDrawer;
      ...
      async onSubmitHandler(evt) {
        ...
        try {
          ...
          if (response.ok && !result.status) {
            ...
            this.updateCartDrawer(updatedCartData);
          } else {
